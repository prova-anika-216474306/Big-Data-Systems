...
#apriori on 80% of the dataset
start80 = time.time()
frequent_pairs = apriori(data_80_percent)

time_for_80_percent = time.time() - start80

print("Time taken for 80 percent of Netflix data: " + str(time_for_80_percent))

f = open("scalability-apriori-netflix-1-80.txt", "a")
f.write("Time taken for 80 percent of Netflix data: " + str(time_for_80_percent))
