...
#apriori on 60% of the dataset
start60 = time.time()
frequent_pairs = apriori(data_60_percent)

time_for_60_percent = time.time() - start60

print("Time taken for 60 percent of Netflix data: " + str(time_for_60_percent))


f = open("scalability-apriori-netflix-1-60.txt", "a")
f.write("Time taken for 60 percent of Netflix data: " + str(time_for_60_percent))
