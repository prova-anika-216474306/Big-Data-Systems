...
#apriori on 20% of the dataset
start20 = time.time()
frequent_pairs = apriori(data_20_percent)

time_for_20_percent = time.time() - start20

print("Time taken for 20 percent of Netflix data: " + str(time_for_20_percent))

f = open("scalability-apriori-netflix-1-20.txt", "a")
f.write("Time taken for 20 percent of Netflix data: " + str(time_for_20_percent))
