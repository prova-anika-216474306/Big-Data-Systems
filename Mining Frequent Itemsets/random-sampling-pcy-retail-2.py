...
#selecting k to be 8000 because the retail file has 8800+ baskets so taking approximately 10% data
random_sample = random.choices(data, k=8000)	
init = []
...
print(print("Time taken for random sampling (PCY) retail data with 2% threshold: " + str(time_taken)) )
