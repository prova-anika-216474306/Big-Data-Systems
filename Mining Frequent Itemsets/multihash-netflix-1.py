...
print("Time taken for running multihash algorithm (PCY) on Netflix data with 1 percent support threshold is: " + str(time_taken))

f = open("multihash-netflix-1.txt", "a")
f.write("Time taken for running multihash algorithm (PCY) on Netflix data with 1 percent support threshold is: " + str(time_taken))
