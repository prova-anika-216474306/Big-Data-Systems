...
print("Time taken for random sampling (PCY) netflix data with 2% threshold: " + str(time_taken)) 
print(length)

f = open("random-sampling-pcy-netflix-2.txt", "a")
f.write("Time taken for random sampling (PCY) netflix data with 2% threshold: " + str(time_taken))
