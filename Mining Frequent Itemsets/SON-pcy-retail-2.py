...
#read data file in chunks. Retail file is total 4,169,728 bytes
def read_in_chunks(file_object, chunk_size=41697):
...
print("SON PCY Retail with support threshold 2% time taken: " + str(time_taken) + '\n')

f = open("SON-pcy-retail-2.txt", "a")
f.write("SON PCY Retail with support threshold 2% time taken: " + str(time_taken) + '\n')
result_str = ','.join(str(item) for item in frequent_pair_main)
f.write(result_str)
f.close()