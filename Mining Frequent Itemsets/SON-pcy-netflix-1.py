...
print("SON PCY Netflix with support threshold 1% time taken: " + str(time_taken) + '\n')

f = open("SON-pcy-netflix-1.txt", "a")
f.write("SON PCY Netflix with support threshold 1% time taken: " + str(time_taken))
